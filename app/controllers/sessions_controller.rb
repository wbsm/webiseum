class SessionsController < ApplicationController
  ...
  def create
    ...
    puts "################# [Webiseum][Session] SessionId trying to login: " + session_user_id.nil ? "nil" : session_user_id
    ...
    puts "################# [Webiseum][Session] User found by SessionId: " + new_social_user.nil ? "nil" : new_social_user
    auth = Authentication.find_or_create(new_social_user, auth_hash)
    puts "################# [Webiseum][Session] Auth created by SessionId: "+ auth.user.id.nil ? "nil" : auth.user.id
